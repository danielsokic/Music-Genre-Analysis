...
music$genre_group <- case_when(
  ...
  grepl("hip hop|rap|trap|drill|gangster rap|melodic rap|conscious hip hop|atl hip hop|east coast hip hop|west coast rap", music$genre, ignore.case = TRUE) ~ "Hip-Hop/Rap",
  grepl("pop|dance pop|viral pop|social media pop|post-teen pop|alt z|electropop|art pop|europop|swedish pop|canadian pop|uk pop|norwegian pop|pop soul|pop rock|pop r&b|indie poptimism", music$genre, ignore.case = TRUE) ~ "Pop",
  grepl("rock|metal|punk|grunge|hard rock|alternative rock|garage rock|modern rock|classic rock|album rock|soft rock|folk rock|permanent wave|shoegaze|protopunk|post-grunge|screamo", music$genre, ignore.case = TRUE) ~ "Rock/Metal",
  grepl("country|country pop|contemporary country|modern country|country road|country rock", music$genre, ignore.case = TRUE) ~ "Country",
  grepl("latin|reggaeton|urbano|bachata|dembow|trap latino|musica mexicana|banda|norteno|corrido|sierreno|tropical|latin pop|latin hip hop|puerto rican pop", music$genre, ignore.case = TRUE) ~ "Latin",
  grepl("r&b|soul|neo soul|contemporary r&b|urban contemporary|british soul", music$genre, ignore.case = TRUE) ~ "R&B/Soul",
  grepl("electro|edm|dance|house|trance|techno|electro house|big room|slap house|dutch house|dutch trance|progressive house|progressive electro house|pop dance", music$genre, ignore.case = TRUE) ~ "Electronic",
  grepl("indie|folk|singer-songwriter|neo mellow|philly indie|pov: indie|small room|slacker rock|dream pop|dreamo|noise pop|indie rock|indie folk|ambient folk|chamber pop|mellow gold|gen z singer-songwriter|canadian singer-songwriter", music$genre, ignore.case = TRUE) ~ "Indie/Folk",
